...
def train(input_variable, target_variable, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
    ...
    clip_grad_norm(encoder.parameters(), 40.0)
    clip_grad_norm(decoder.parameters(), 40.0)
...
trainIters(encoder1, attn_decoder1, 300000, print_every=1000)
